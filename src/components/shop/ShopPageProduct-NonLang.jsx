...
class ShopPageProductNonLangganan extends Component {
    constructor(props) {
        super(props);
    ...
    async componentDidMount() {
        ...
        Axios.post(url.select, {
            ...
            let get_seller = encrypt("select string_agg(cast(gcl.seller_id as varchar), ',') as seller FROM gcm_master_company gmc ,gcm_company_listing gcl " +
                "where gcl.seller_id = gmc.id  and gcl.buyer_id = " + decrypt(localStorage.getItem('CompanyIDLogin')) + " and gcl.status = 'A' and gmc.seller_status = 'A'")

            Axios.post(url.select, {
                query: get_seller
            }).then(async (data) => {
                let getrelated_product = encrypt("SELECT nama, b.id, b.kode_barang, price, foto, category_id, b.company_id, berat, " +
                    "b.deskripsi, c.nama_perusahaan FROM gcm_master_company c, gcm_master_barang a " +
                ...
                Axios.post(url.select, {
                    ...
                    if (related_product_length < 5) {
                        ...
                        let id_get, kode_barang_get, nama_get, category_id_get, company_id_get;
                        let nama_perusahaan_get, foto_get, price_get, price_terendah_get;
                        let deskripsi_get, jumlah_min_beli_get, jumlah_min_nego_get, berat_get, satuan_get, kurs;
    ...
    render() {
        ...
        const breadcrumb = [
            { title: 'Beranda', url: '' },
            { title: 'Daftar Produk Non Langganan', url: '/daftarproduknonlangganan' },
                ...
                <div className="container">
                    <div className={`shop-layout shop-layout--sidebar--${sidebarPosition}`}>
                        ...
                        <div className=" shop-layout__content">
                            <div className=" block">
                                <Product product={this.state.product_detail} layout={layout} hide_harga={true} />
                    ...
                    <div className="block">
                        {
                            cek_loaddata > 0 ?
                                (<div className="container">
                                    <Product product={this.state.product_detail} hide_harga={true} cart={this.state.status_cart} layout={layout} kurs={this.state.kurs} />
                                    <ProductTabs />
                                </div>) :
                                (<div className="container">
...
ShopPageProductNonLangganan.propTypes = {
...
ShopPageProductNonLangganan.defaultProps = {
    layout: 'standard',
    sidebarPosition: 'start',
};

export default ShopPageProductNonLangganan;
