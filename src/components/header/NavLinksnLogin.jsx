...
// data stubs
import navLinksnLogin from '../../data/headerNavigationnotLogin';

function NavLinksnLogin(props) {
    ...
    const linksList = navLinksnLogin.map((item, index) => {
        let arrow;
        let submenu;
...
export default connect(mapStateToProps)(NavLinksnLogin);
