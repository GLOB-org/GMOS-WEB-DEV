...
export default class InfoCompanyCard extends Component{
    ...
    detailComplain = async(id)=>{
        ...
        let queryDetailReceived = encrypt("select a.id, a.transaction_id, c.nama, a.qty, a.harga, "+
        ...
        "from gcm_transaction_detail a inner join "+
    ...
    detailReceived= async(id)=>{
        ...
        let queryDetailReceived = encrypt("select a.id, a.transaction_id, c.nama, a.qty, a.qty_dipenuhi, a.harga, a.batch_number, "+
        "case when b.flag_foto = 'Y' then "+
        "(select concat('https://www.glob.co.id/admin/assets/images/product/', b.company_id,'/',b.kode_barang,'.png')) "+
        "else 'https://glob.co.id/admin/assets/images/no_image.png' end as foto, " +
