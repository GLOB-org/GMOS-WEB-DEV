...
export default class InfoCompanyCard extends Component{
    constructor(props){
        ...
        this.state={
            ...
            total_trx_final: '',
            isOpen: false, display_timeline: 'none',
            penjual: ''
        }
    }
    ...
    detailShipped = async(id)=>{

        Toast.loading('loading . . .', () => {
        }); 

        let queryDetailShipped = encrypt("select a.id, a.transaction_id, c.nama, b.foto, a.qty, a.qty_dipenuhi, a.harga, a.batch_number, "+
    ...
    return(
        ...
        <tr id='rowTransactionShipped' style={{fontSize:'13px', color:'#3D464D'}}>
            <td style={{textAlign: 'center'}}><strong><label id='idTransaction' onClick={()=>this.detailShipped(this.props.data.id_transaction)}>{this.props.data.id_transaction}</label></strong></td>
            <td style={{textAlign: 'center'}}>{this.props.data.create_date_edit}</td>
            <td style={{textAlign: 'center'}}>{this.props.data.date_shipped}</td>
            ...
            <td>
                <div className="buttonAction">
                    <center>
                        <button type="button" class="btn btn-primary btn-xs"  onClick={()=>this.props.handleTerimaPesanan(this.props.data.id_transaction)}>Terima Barang</button>
                    </center>
                </div>                     
            </td>
        </tr> 
                    ...
                    <div className="row">
                        ...
                        <div className="col-md-4">
                            <div className="address-card__row">
                                ...
                                <span style={{fontSize: '14px', fontWeight: '500'}}>
                                    <div className="address-card__row-content"><strong>Dikirim</strong></div>
                                </span>
                            </div> 
                        </div>
                        <div className="col-md-4">
