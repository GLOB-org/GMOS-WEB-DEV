...
export default class InfoCompanyCard extends Component{
    ...
    detailCanceled = async(id)=>{
        ...
        // let queryDetailCanceled = encrypt("select a.id, a.transaction_id, c.nama, a.qty, a.harga, b.id, c.berat, d.alias as satuan, b.company_id as penjual, "+
        ...
        <tr id='rowTransactionCanceled' style={{fontSize:'13px', color:'#3D464D'}}>
            <td>
                <div className="buttonAction">
                    <center>
                        <button type="button" class="btn btn-xs btn-detail-transaction" onClick={()=>this.detailCanceled(this.props.data.id_transaction)} >Lihat Detail</button>
                    </center>
                </div>
            </td>
