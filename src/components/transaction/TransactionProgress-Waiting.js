...
export default class InfoCompanyCard extends Component{
    ...
    return(
        ...
        <tr id='rowTransactionWaiting' style={{fontSize:'13px', color:'#3D464D'}}>
            <td style={{textAlign: 'center'}}><strong><label id='idTransaction' onClick={()=>this.detailWaiting(this.props.data.id_transaction)}>{this.props.data.id_transaction}</label></strong></td>
