...
export default class InfoCompanyCard extends Component{
    constructor(props){
        ...
        this.state={
            ...
            total_trx_final: '',
            isOpen: false, isOpenTimeline: false, display_timeline: 'none',
            penjual: '',
            displayImagePO: 'none'
        }
    }
    ...
    detailOngoing = async(id)=>{

        Toast.loading('loading . . .', () => {
        }); 

        let queryDetailOngoing = encrypt("select a.id, a.transaction_id, c.nama, a.qty, a.qty_dipenuhi, a.harga, a.batch_number, "+
        ...
        // let queryDetailOngoing = encrypt("select a.id, a.transaction_id, c.nama, a.qty, a.qty_dipenuhi, a.harga, a.batch_number, b.id, c.berat, d.alias as satuan, b.company_id as penjual, "+
        // "case when b.flag_foto = 'Y' then "+
        // "(select concat('https://www.glob.co.id/admin/assets/images/product/', b.company_id,'/',b.kode_barang,'.png')) "+
        // "else 'https://glob.co.id/admin/assets/images/no_image.png' end as foto, " +
    ...
    return(
        ...
        <tr id='rowTransactionOngoing' style={{fontSize:'13px', color:'#3D464D'}}>
            <td>
                <div className="buttonAction">
                    <center>
                        <button type="button" class="btn btn-xs btn-detail-transaction" onClick={()=>this.detailOngoing(this.props.data.id_transaction)} >Lihat Detail</button>
                    </center>
                </div>
            </td>
            ...
            <td style={{textAlign: 'center'}}>{this.props.data.date_ongoing}</td>
            ...
            <Modal isOpen={this.state.isOpenTimeline} size="md" centered>
                <ModalHeader className="stickytopmodal" toggle={()=>this.setState({isOpenTimeline: false})}>Timeline Transaksi</ModalHeader>
                    <ModalBody >
                    <div className="row">
                        <div className="col-md-12">
                            ...
                            <ul className="timeline">
                                <li>
                                    ...
                                    <label className="float-right">21 March, 2014</label>
                                </li>
                                <li>
                                    <label><strong>Diproses</strong></label>
                                    <label className="float-right">21 March, 2014</label>
                                </li>
                            </ul>
                        </div>
                    ...
                    <div className="row">
                        ...
                        <div className="col-md-4 d-print-none">
                            <div className="address-card__row">
                                ...
                                <span style={{fontSize: '14px', fontWeight: '500'}}>
                                    <div className="address-card__row-content"><strong>Diproses</strong></div>
                                </span>
                            </div> 
                        </div>
                        <div className="col-md-4">
