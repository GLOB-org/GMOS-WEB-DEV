...
export default class InfoCompanyCard extends Component{
    ...
    detailOngoing = async(id)=>{
        ...
        let queryDetailOngoing = encrypt("select a.id, a.transaction_id, c.nama, b.foto, a.qty, a.qty_dipenuhi, a.harga, a.batch_number, "+
    ...
    return(
        ...
        <tr id='rowTransactionOngoing' style={{fontSize:'13px', color:'#3D464D'}}>
            <td style={{textAlign: 'center'}}><strong><label id='idTransaction' onClick={()=>this.detailOngoing(this.props.data.id_transaction)}>{this.props.data.id_transaction}</label></strong></td>
